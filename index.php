...
<div class="topmenu w-100 px-2">  
    <div class="swiper-container">  
        <div class="swiper-wrapper">
            <?php
            echo '<span class="swiper-slide"><a href="./" class="text-primary">トップページ</a></span>';
...
<div class="container d-lg-none d-md-none p-0">
 ...
 ?>
  ...
  <div class="container py-2">
    ...
    "> 
   <h3 class="pt-5 pb-2 text-white">こんにちは！</h3>
    <form>
  <div class="form-group" >
      <input type="text" name="v" style="width: 50%;height: 50px;border: none;box-sizing: border-box;padding: 14px 18px;" placeholder="動画IDまたはYouTubeリンクを入力してください"  autocomplete="off" /><button type="submit"  style="width: 18%;border: none;height: 50px;background-color: #e62117;color: #fff;font-size: 18px;display: inline-block;" ><i class="fa fa-youtube-play fa-lg pr-1"></i>再生</button>
  </div>
    </form>
    </div>
    ...
    <div class="col-8 sm-p">
      <span class="txt2 ricon h5">最近の人気</span>
    </div>
    <div class="col-4 text-right sm-p">
      <a href="./content.php?cont=trending" title="もっと" target="_blank" class="icontext h6 pl-1 ">もっと<i class="fa d-inline fa-lg fa-angle-double-right"></i></a>
    </div>
  </div>
