    ...
    <div class="row">
        <div class="col-md-8 col-sm-12 col-xs-12 col-lg-8 leffix">
            ...
            <div class="vinfo fsize2 clearfix">
                ...
                <span class="pull-left ">カテゴリー<a href="./content.php?cont=category&sortid=<?php echo $videodata['items']['0']['snippet']['categoryId']?>" class="pl-2 d-inline"  target="_blank"><?php echo categorieslist($videodata['items']['0']['snippet']['categoryId'])?></a>
                </span>
                <span class="pull-right">
                    <span id="fxs" data-toggle="popover" title="シェア" data-html="true" data-placement="left" data-content="<?php echo shareit($videodata['items']['0']['id'],$videodata['items']['0']['snippet']['title']);?>">
                    <i class="fa fa-share-square-o pr-1"></i>シェア
                </span>
                <span class="pr-1">
                    <a href="./content.php?cont=video&v=<?php echo $videodata['items']['0']['id'] ?>" target="_blank" class="fsize2"><i class="fa fa-share-square-o pr-1"></i>ダウンロード</a>
                </span>
                </span>
             </div>
                ...
                <div id="accdiv" class="px-3 py-2 mt-2 fsize2 clearfix ">
                    ...
                    <a href="./channel.php?channelid=<?php echo $videodata['items']['0']['snippet']['channelId'] ?>" class="btn btn-sm btn-c pull-right fsize2 my-1"><p class="text-primary m-0 px-2">ホーム</p></a>
        ...
        <div id="tags" class="w-100 pb-2 vinfo">
         ...
         <div class="col-md-4 col-sm-12 col-xs-12 col-lg-4 related">
            <div class="font-weight-bold h6 pb-1">関連コンテンツ</div> 
